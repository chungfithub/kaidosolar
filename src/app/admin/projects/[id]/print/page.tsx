...
export default async function PrintProjectQuotationPage({ params }: { params: Promise<{ id: string }> }) {
      ...
      <div className="print-container">
        ...
        <div className="header-section">
          <div className="logo-box">
            <h2 style={{ color: '#0ea5e9', fontSize: '32px', margin: 0, fontWeight: 900, fontStyle: 'italic', letterSpacing: '1px' }}>
        ...
        <div className="quotation-title">
          <h1>BẢNG BÁO GIÁ THIẾT BỊ VÀ THI CÔNG DỰ ÁN</h1>
          <p>({dateString})</p>
        </div>
        ...
        <div className="customer-info">
          ...
          <p style={{ marginTop: '12px', marginBottom: '8px' }}>
            Kaido Solar trân trọng gửi tới Quý Khách hàng bảng báo giá hệ thống điện năng lượng mặt trời chi tiết dưới đây:
          </p>
        </div>
        ...
        <div className="signature-section">
          ...
          <div className="signature-box">
            ...
            <strong style={{ textTransform: 'uppercase' }}>CÔNG TY TNHH ĐIỆN MẶT TRỜI KAIDO</strong>
          </div>
        </div>
      </div>
    </>
