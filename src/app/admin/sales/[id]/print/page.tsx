...
export default async function PrintSalePage({ params }: { params: { id: string } }) {
  ...
  return (
    <>
      <PrintTrigger label="🖨️ In Hóa Đơn" />
      ...
      <div className="print-container">
          ...
          <table>
            <tbody>
              <tr>
                ...
                <td style={{ width: '45%' }}><strong>{sale.customerName}</strong></td>
                <td style={{ width: '15%' }}>Mã đơn:</td>
                <td style={{ width: '25%' }}><strong>#{sale.id.toString().padStart(4, '0')}</strong></td>
              </tr>
              <tr>
                <td>Điện thoại:</td>
        ...
        <div className="footer-notes">
          {sale.notes && (
            <p><strong>Ghi chú:</strong> {sale.notes}</p>
          )}
          <p>Cảm ơn quý khách đã mua sắm tại Kaido Solar!</p>
        </div>
